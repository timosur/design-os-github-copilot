...
"Note: Design system hasn't been defined yet. I'll use default styling, but for consistent branding, consider running `/design-tokens` first."
...
**If `product/design-system/design-system.json` exists:**
